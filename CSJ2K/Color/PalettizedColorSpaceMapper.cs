...
namespace CSJ2K.Color
{
    ...
    public class PalettizedColorSpaceMapper : ColorSpaceMapper
    {
        ...
        /// </param>
        public PalettizedColorSpaceMapper(BlkImgDataSrc src, ColorSpace csMap)
            : base(src, csMap)
        {
        ...
        {
            if (ncomps != 1 && ncomps != 3) throw new ColorSpaceException("wrong number of components (" + ncomps + ") for palettized image");
        ...
        {
            if (pbox == null) return src.getCompData(out_Renamed, c);
            ...
            int rightedgeIn; // offset to the end of the input
        ...
        {
            int c;
            StringBuilder rep = new StringBuilder("[PalettizedColorSpaceMapper ");
        ...
        /// component. If this number is <code>n</code> then for unsigned data the
        ...
        /// 
        /// </param>
        /// <returns> The width in pixels of component <code>c</code> in tile<code>t</code>.
        /// 
        /// </returns>
        ...
        /// 
        /// </param>
        /// <returns> The height in pixels of component <code>c</code> in tile
        /// <code>t</code>.
        /// 
        /// </returns>
        ...
        /// 
        /// </param>
        /// <returns> The width in pixels of component <code>c</code> in the overall
        /// image.
        /// 
        /// </returns>
