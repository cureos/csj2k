...
namespace CSJ2K.Color
{
    ...
    public class SYccColorSpaceMapper : ColorSpaceMapper
    {
        ...
        protected const float Matrix00 = 1;

        /// <summary>Matrix component for ycc transform. </summary>
        protected const float Matrix01 = 0;

        /// <summary>Matrix component for ycc transform. </summary>
        protected const float Matrix02 = (float)1.402;

        /// <summary>Matrix component for ycc transform. </summary>
        protected const float Matrix10 = 1;

        /// <summary>Matrix component for ycc transform. </summary>
        protected const float Matrix11 = (float)-0.34413;

        /// <summary>Matrix component for ycc transform. </summary>
        protected const float Matrix12 = (float)-0.71414;

        /// <summary>Matrix component for ycc transform. </summary>
        protected const float Matrix20 = 1;

        /// <summary>Matrix component for ycc transform. </summary>
        protected const float Matrix21 = (float)1.772;

        /// <summary>Matrix component for ycc transform. </summary>
        protected const float Matrix22 = 0;
        ...
        /// </param>
        public SYccColorSpaceMapper(BlkImgDataSrc src, ColorSpace csMap)
            : base(src, csMap)
        {
            initialize();
        }
        ...
        {
            if (inblk.Length != 3) throw new ArgumentException("bad input array size");
        ...
        private static DataBlkInt[] mult(DataBlkInt[] inblk)
        {
            ...
            for (j = 0; j < length; ++j)
            {
                out_Renamed[0][j] =
                    (int)
                    (Matrix00 * in_Renamed[0][inblk[0].offset + j] + Matrix01 * in_Renamed[1][inblk[1].offset + j]
                     + Matrix02 * in_Renamed[2][inblk[2].offset + j]);

                out_Renamed[1][j] =
                    (int)
                    (Matrix10 * in_Renamed[0][inblk[0].offset + j] + Matrix11 * in_Renamed[1][inblk[1].offset + j]
                     + Matrix12 * in_Renamed[2][inblk[2].offset + j]);

                out_Renamed[2][j] =
                    (int)
                    (Matrix20 * in_Renamed[0][inblk[0].offset + j] + Matrix21 * in_Renamed[1][inblk[1].offset + j]
                     + Matrix22 * in_Renamed[2][inblk[2].offset + j]);
            }
        ...
        public override string ToString()
        {
            ...
            StringBuilder rep = new StringBuilder("[SYccColorSpaceMapper ");
