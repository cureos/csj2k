namespace CSJ2K
{
	...
	public class J2kImage
	{
		...
		public static byte[] ToBytes(params Stream[] streams)
		{
			...
			SupportClass.StreamTokenizerSupport stok = new SupportClass.StreamTokenizerSupport(new StringReader(pl.getParameter("tiles")));
