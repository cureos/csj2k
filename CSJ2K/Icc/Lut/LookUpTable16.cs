...
namespace CSJ2K.Icc.Lut
{
    ...
    public abstract class LookUpTable16 : LookUpTable
    {
        ...
        {
            StringBuilder rep = new StringBuilder("[LookUpTable16 ");
        ...
        {
            StringBuilder rep = new StringBuilder("[LookUpTable16" + eol);
            int row, col;
            ...
            // Partial row.
            rep.Append("lut[" + 10 * row + "] : ");
            for (col = 0; col < dwNumInput % 10; ++col) rep.Append(lut[10 * row + col] + " ");
            rep.Append(eol + eol);
            return rep.ToString();
        }
        ...
        /// <param name="dwMaxOutput">max output value of the lut
        /// </param>
        protected internal LookUpTable16(int dwNumInput, int dwMaxOutput)
            : base(null, dwNumInput)
        {
        ...
        /// <param name="dwMaxOutput">max output value of the lut
        /// </param>
        protected internal LookUpTable16(ICCCurveType curve, int dwNumInput, int dwMaxOutput)
            : base(curve, dwNumInput)
        {
            this.dwMaxOutput = dwMaxOutput;
            lut = new short[dwNumInput];
        }
